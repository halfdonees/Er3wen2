...
void StatusCheck::Check(CM730 &cm730)
{
    ...
    if(m_old_btn & BTN_MODE)
    {
        ...
        {
            m_cur_mode++;
            if(m_cur_mode >= MAX_MODE) m_cur_mode = READY; //MAX_MODE is in StatusCheck.h, enum
        }
        ...
        else if(m_cur_mode == SOCCER)
        {
            ...
            LinuxActionScript::PlayMP3("../../../Data/mp3/error.mp3");
        }
    ...
    if(m_old_btn & BTN_START)
    {
        if(m_is_started == 0)
        {
            ...
            if(m_cur_mode == SOCCER)
            {
                ...
                m_is_started = 1;
                LinuxActionScript::PlayMP3("../../../Data/mp3/critical stop.mp3");
                ...
                while(1)
                {
                    ...
                    {
                        LinuxActionScript::PlayMP3Wait("../../../Data/mp3/shut down.mp3");
                        MotionManager::GetInstance()->ResetGyroCalibration();
                    }
                    usleep(8000);
                }
